...
**Recent (2026-05-28):** Structured extract parsing ([#12](https://github.com/weijia-89/oncology-rag-lab/pull/12) — `LlmExtractPayload` in `extract.py`). **2026-05-23:** injection guard ([#2](https://github.com/weijia-89/oncology-rag-lab/pull/2)); regimen/histology GEval ([#3](https://github.com/weijia-89/oncology-rag-lab/pull/3)). Near-term ROADMAP items (lockfile, in-memory Chroma fixture, edge-case gold) are shipped on `main`; see `ROADMAP.md`.
