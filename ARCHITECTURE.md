...
- Dev dependencies (`pytest`, `ruff`, `pytest-json-report`, `pytest-asyncio`) are in the `dev` dependency group.
...
tests/unit/          fast, no Ollama (test_chunking, test_extract_parse, test_llm_client)
